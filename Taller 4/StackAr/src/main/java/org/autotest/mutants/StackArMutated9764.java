...
/**
 * FalseConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por false en la línea 108.
 */
public class StackArMutated9764 extends org.autotest.Stack {
    ...
    public StackArMutated9764() {
        this(org.autotest.mutants.StackArMutated9764.DEFAULT_CAPACITY);
    }

    public StackArMutated9764(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated9764 other = ((org.autotest.mutants.StackArMutated9764) (obj));
        if (false) {
            return false;
        }
