...
/**
 * TrueConditionalsMutator: Se reemplazó !java.util.Arrays.equals(elems, other.elems) por true en la línea 108.
 */
public class StackArMutated3235 extends org.autotest.Stack {
    ...
    public StackArMutated3235() {
        this(org.autotest.mutants.StackArMutated3235.DEFAULT_CAPACITY);
    }

    public StackArMutated3235(int capacity) throws java.lang.IllegalArgumentException {
        if (capacity < 0) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        org.autotest.mutants.StackArMutated3235 other = ((org.autotest.mutants.StackArMutated3235) (obj));
        if (true) {
            return false;
        }
